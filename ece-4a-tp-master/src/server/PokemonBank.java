			...
			switch(request) {
				case LIST:
					...
					if (this.pokemons.size() == 0) {
						 ...
						 */
						objectOutputStream.writeObject("There is no Pokémons");
					} else {
						/*
						 * TODO
						 ...
						 * - the output stream
						 */
						StringBuilder stringBuilder = new StringBuilder("List of Pokémons\n");
				...
				case STORE:
					 ...
					 */
					objectOutputStream.writeObject("Your Pokémon is safe");
